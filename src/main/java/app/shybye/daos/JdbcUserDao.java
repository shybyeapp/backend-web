...
import app.shybye.exceptions.InvalidUsernamePasswordException;
import app.shybye.exceptions.UserIdNotFoundException;
import app.shybye.exceptions.UsernameNotFoundException;
...
public class JdbcUserDao implements UserDao {
	...
	public void createUser(User newUser) {
		...
		try {
			jdbcTemplate.queryForObject(sql, Integer.class, newUser.getUsername(), newUser.getPassword(),
					newUser.getUserPoints());
